...
class TransmissibilityVitroPries(Transmissibility):
    ...
    cells is considered by the empirical in vitro equations by Pries, Neuhaus, Gaehtgens (1992). This part is the same
    to the empirical in vitro equations by Pries and Secomb (2005).
    """

    def update_transmiss(self, flownetwork):
        """
        Update the transmissibility in flownetwork based on poiseuille's law and the empirical in vitro equations
        by Pries et al. (1992, 2005).
